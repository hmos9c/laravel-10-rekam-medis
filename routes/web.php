...
use App\Http\Controllers\ReportDoctorController;
use App\Http\Controllers\EmployeePrintController;
use App\Http\Controllers\ReportPatientController;
...
Route::resource('/document', DocumentController::class)->middleware('admin');
Route::get('/document/create/{doctor:id_doctor}', [DocumentController::class, 'create'])->middleware('admin');
...
Route::get('/reportpatient', [ReportPatientController::class, 'index'])->middleware('admin');
Route::get('/reportdate', [ReportDateController::class, 'index'])->middleware('admin');
Route::get('/reportdoctor', [ReportDoctorController::class, 'index'])->middleware('admin');

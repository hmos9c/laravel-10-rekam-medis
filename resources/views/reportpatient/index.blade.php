      ...
      <table class="table table-hover my-0">
        <thead>
          <tr>
            ...
            <th>Nama Pasien</th>
            <th>Tanggal Masuk</th>
            <th class="d-none d-md-table-cell">Tanggal Keluar</th>
            <th>Aksi</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td class="d-none d-md-table-cell">{{ \Carbon\Carbon::parse($record->outdate)->format('d/m/Y')}}</td>
            <td>

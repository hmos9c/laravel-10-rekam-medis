...
@section('main')
<h3 class="mb-3"><strong>Detail</strong> Bentuk Obat</h3>
<div class="row">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="description" id="description" rows="2" readonly>{{$form->description}}</textarea>
        </div>
        <div class="mt-3 d-flex justify-content-end">
          <a class="btn btn-secondary" href="/form">Kembali</i></a>
          <a class="btn btn-warning mx-1" href="/form/{{$form->id}}/edit">Ubah</i></a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center">
                  <p class="text-success">Anda yakin menghapus?
                    <form action="/form/{{$form->id}}" method="post" class="mx-1">
                      @method('delete')
                      @csrf

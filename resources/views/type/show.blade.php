...
@section('main')
<h3 class="mb-3"><strong>Detail</strong> Jenis Obat</h3>
<div class="row">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="name" name="name" value="{{$type->name}}" readonly>
        </div>
        <div class="mb-3">
          <label for="description" class="form-label">Deskripsi</label>
          <textarea class="form-control" name="description" id="description" rows="2" readonly>{{$type->description}}</textarea>
        </div>
        <div class="mt-3 d-flex justify-content-end">
          <a class="btn btn-secondary" href="/type">Kembali</i></a>
          <a class="btn btn-warning mx-1" href="/type/{{$type->id}}/edit">Ubah</i></a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center">
                  <p class="text-success">Anda yakin menghapus?
                    <form action="/type/{{$type->id}}" method="post" class="mx-1">
                      @method('delete')
                      @csrf
